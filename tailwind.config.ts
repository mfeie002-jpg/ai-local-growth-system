  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        editorial: ["ui-sans-serif", "system-ui", "-apple-system", "BlinkMacSystemFont", "\"Segoe UI\"", "sans-serif"],
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 40px hsl(var(--primary) / 0.5), 0 0 60px hsl(var(--ai-accent) / 0.3)" },
        },
      },
      animation: {
